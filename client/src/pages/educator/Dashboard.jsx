...
const Dashboard = () => {
  ...
  const fetchDashboardData = () => {
    return setDashboardData(dummyDashboardData)
  }
  ...
  return dashboardData ? (
      <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 pb-0' > 
          <div className='space-y-5' > 
              ...
              <div> 
                ...
                bg-white border border-gray-500/20'>
                  <table className='table-fixed md:text-auto w-full overflow-hidden'> 
                    <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left'>
                      <tr> 
                        <th className='px-4 py-3 font-semibold text-center hidden sm:table-cell'>#</th>
                        <th className='px-4 py-3 font-semibold'>Student Name</th>
                        <th className='px-4 py-3 font-semibold'>Course Tittle</th>
                      </tr>
                    </thead>
