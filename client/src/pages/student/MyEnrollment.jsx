...
const MyEnrollment = () => { 
  ...
  const {enrolledCourses ,  calculateCourseDuration , navigator} = useContext(AppContext)
      ...
      <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'> 
        ...
        <tbody className='text-gray-700'> 
          ...
          <td className='px-4 py-3 max-sm:text-right'>
            <button className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white' onClick={ () => navigator('/player/' + course.__id)}> { progressArray[index].lectureCompleted / progressArray[index].totalLectures === 1 ? 'Completed' : 'On Going' }</button>
          </td>
