  ...
  return courseData ? (
    <>
      ...
      items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* Background */}
        <div className='absolute top-0 left-0 w-full h-sectionHeight -z-10 bg-gradient-to-b from-cyan-100/70'></div>

        {/* LEFT COLUMN */}
        <div className='flex-1 max-w-xl z-10 text-gray-500 pt-3 pb-1 text-sm'>
          ...
          <p className='text-sm'>
            Course by : <span className='text-blue-600 underline'>GreetStack</span>
          </p>
                        ...
                        <li key={i} className='flex items-start gap-2 py-1'>
                          ...
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                            ...
                            <div className='flex gap-2'>
                              ...
                              <p>
                                {humanizeDuration(lecture.lectureDuration * 60 * 100, {
                                  units: ['h', 'm'],
                                })}
                              </p>
                            </div>
        ...
        {/* RIGHT COLUMN */}
        <div className='w-full md:w-[420px] z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white'>
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
              <div className='flex items-center gap-1'>
                <img src={assets.star} alt="start icons" />
                <p>{calculateRating(courseData)}</p>
              </div>
