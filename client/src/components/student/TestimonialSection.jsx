...
const TestimonialSection = () => {
    return (
        <div className='pb-14 px-8 md:px-0'>
            ...
            <p className='ms:text-base text-gray-500 mt-3'>Hear from our learners as they share
                their journey of trasformation, success, and how our <br /> platform has made a difference
                in their lives </p>
